...
/obj/item/weapon/reagent_containers/food/snacks/grown/cherries
	...
	New(var/loc, var/potency = 10)
		...
		if(reagents)
			...
			reagents.add_reagent("fructose", 1+round((potency / 15), 1))
			reagents.add_reagent("vitaminc", 1+round((potency / 25), 1))			
			bitesize = 1+round(reagents.total_volume / 2, 1)
...
/obj/item/weapon/reagent_containers/food/snacks/grown/harebell
	...
	New(var/loc, var/potency = 1)
		...
		if(reagents)
			...
			reagents.add_reagent("chlorophyllb", 1+round((potency / 15), 1))			
			bitesize = 1+round(reagents.total_volume / 3, 1)
...
/obj/item/weapon/reagent_containers/food/snacks/grown/grapes
	...
	New(var/loc, var/potency = 10)
		...
		if(reagents)
			...
			reagents.add_reagent("flavanol", 1+round((potency / 10), 1))
			reagents.add_reagent("chlorophyllb", 1+round((potency / 25), 1))
			bitesize = 1+round(reagents.total_volume / 2, 1)
...
/obj/item/weapon/reagent_containers/food/snacks/grown/greengrapes
	...
	New(var/loc, var/potency = 25)
		...
		if(reagents)
			reagents.add_reagent("nutriment", 1+round((potency / 10), 1))
			reagents.add_reagent("kelotane", 3+round((potency / 25), 1))
			reagents.add_reagent("flavanol", 1+round((potency / 5), 1))
			reagents.add_reagent("chlorophyllb", 1+round((potency / 10), 1))
			bitesize = 1+round(reagents.total_volume / 2, 1)
...
/obj/item/weapon/reagent_containers/food/snacks/grown/berries
	...
	New(var/loc, var/potency = 10)
		...
		if(reagents)
			reagents.add_reagent("nutriment", 1+round((potency / 10), 1))
			reagents.add_reagent("vitaminc", 1+round((potency / 50), 1))						
			bitesize = 1+round(reagents.total_volume / 2, 1)
...
/obj/item/weapon/reagent_containers/food/snacks/grown/poisonberries
	...
	New(var/loc, var/potency = 15)
		...
		if(reagents)
			...
			reagents.add_reagent("ricin", 1+round(potency / 25, 1))
			bitesize = 1+round(reagents.total_volume / 2, 1)
...
/obj/item/weapon/reagent_containers/food/snacks/grown/deathberries
	...
	New(var/loc, var/potency = 50)
		...
		if(reagents)
			reagents.add_reagent("nutriment", 1)
			reagents.add_reagent("toxin", 3+round(potency / 10, 1))
...
/obj/item/weapon/reagent_containers/food/snacks/grown/apple
	...
	New(var/loc, var/potency = 15)
		...
		if(reagents)
			...
			reagents.add_reagent("fructose", 1+round((potency / 10), 1))
			reagents.add_reagent("vitaminc", 1+round((potency / 20), 1))			
...
/obj/item/weapon/reagent_containers/food/snacks/grown/watermelon
	...
	New(var/loc, var/potency = 10)
		...
		if(reagents)
			reagents.add_reagent("nutriment", 1+round((potency / 50), 1))
			reagents.add_reagent("fructose", 1+round((potency / 5), 1))
			reagents.add_reagent("vitaminc", 1+round((potency / 50), 1))						
			bitesize = 1+round(reagents.total_volume / 2, 1)
...
/obj/item/weapon/reagent_containers/food/snacks/grown/pumpkin
	...
	New(var/loc, var/potency = 10)
		...
		if(reagents)
			...
			reagents.add_reagent("betacarotene", 1+round((potency / 5), 1))						
			bitesize = 1+round(reagents.total_volume / 2, 1)
...
/obj/item/weapon/reagent_containers/food/snacks/grown/lime
	...
	New(var/loc, var/potency = 20)
		...
		if(reagents)
			reagents.add_reagent("nutriment", 1+round((potency / 20), 1))
			reagents.add_reagent("vitaminc", 1+round((potency / 5), 1))				
			bitesize = 1+round(reagents.total_volume / 2, 1)
...
/obj/item/weapon/reagent_containers/food/snacks/grown/lemon
	...
	New(var/loc, var/potency = 20)
		...
		if(reagents)
			reagents.add_reagent("nutriment", 1+round((potency / 20), 1))
			reagents.add_reagent("vitaminc", 1+round((potency / 5), 1))							
			reagents.add_reagent("chlorophyllb", 1+round((potency / 5), 1))
			bitesize = 1+round(reagents.total_volume / 2, 1)
...
/obj/item/weapon/reagent_containers/food/snacks/grown/orange
	...
	New(var/loc, var/potency = 20)
		...
		if(reagents)
			reagents.add_reagent("nutriment", 1+round((potency / 20), 1))
			reagents.add_reagent("fructose", 1+round((potency / 25), 1))			
			reagents.add_reagent("vitaminc", 1+round((potency / 5), 1))							
			bitesize = 1+round(reagents.total_volume / 2, 1)
...
/obj/item/weapon/reagent_containers/food/snacks/grown/tomato
	...
	New(var/loc, var/potency = 10)
		...
		if(reagents)
			reagents.add_reagent("nutriment", 1+round((potency / 10), 1))
			reagents.add_reagent("flavanol", 1+round((potency / 25), 1))
			reagents.add_reagent("vitaminc", 1+round((potency / 25), 1))			
			bitesize = 1+round(reagents.total_volume / 2, 1)
...
/obj/item/weapon/reagent_containers/food/snacks/grown/carrot
	...
	New(var/loc, var/potency = 10)
		...
		if(reagents)
			reagents.add_reagent("nutriment", 1+round((potency / 20), 1))
			reagents.add_reagent("betacarotene", 1+round((potency / 5), 1))			
			reagents.add_reagent("imidazoline", round(potency / 25, 1))
			bitesize = 1+round(reagents.total_volume / 2, 1)
...
/obj/item/weapon/reagent_containers/food/snacks/grown/mushroom/reishi
	...
	New(var/loc, var/potency = 10)
		...
		if(reagents)
			reagents.add_reagent("nutriment", 1)
			reagents.add_reagent("anti_toxin", 3+round(potency / 10, 1))
...
/obj/item/weapon/reagent_containers/food/snacks/grown/mushroom/amanita
	...
	New(var/loc, var/potency = 10)
		...
		if(reagents)
			reagents.add_reagent("nutriment", 1)
			reagents.add_reagent("amatoxin", 1+round(potency / 50, 1))			
			reagents.add_reagent("muscmol", 1+round(potency / 20, 1))
			bitesize = 1+round(reagents.total_volume / 2, 1)
...
/obj/item/weapon/reagent_containers/food/snacks/grown/mushroom/amanita/attackby(var/obj/item/O as obj, var/mob/user as mob)
	...
	if (istype(O, /obj/item/device/analyzer/plant_analyzer))
		...
		user << "<span class='info'>- Muscmol: <i>[reagents.get_reagent_amount("muscmol")]%</i></span>"
...
/obj/item/weapon/reagent_containers/food/snacks/grown/tea_astra
	...
	New(var/loc, var/potency = 20)
		...
		if(reagents)
			reagents.add_reagent("teapowder", 1+round((potency / 10), 2))
			reagents.add_reagent("kelotane", 1+round((potency / 25), 1))
